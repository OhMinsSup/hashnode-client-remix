      ...
      <div className={styles.root}>
        ...
        <div className={styles.right}>
          <div className={styles.form}>
            <svg className={styles.logo} fill="none" viewBox="0 0 334 56">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <p className={styles.terms}>
              ...
              and
              <a target="_blank" className="font-medium" href="/privacy">
                {" "}
                Privacy Policy
              </a>
            </p>
          ...
          <button
            className={cn(styles.btn_bottom, styles.btn_bottom_go_back)}
            onClick={() => navigate(-1)}
          >
            <svg fill="none" viewBox="0 0 16 16" width="16" height="16">
              <path
