...
// components
import TrendingTags from "~/components/__ui/main/TrendingTags";
import {
  TrendingIcon,
  ExploreIcon,
  BookmarkIcon,
      ...
      >
        <div className="container">
          <div className="menu-contents">
            <SidebarNavLink text="My Feed" to="/" end icon={<FeedIcon />} />
            <SidebarNavLink
              text="Explore"
              to="/explore"
              icon={<ExploreIcon />}
            />
            <SidebarNavLink text="Drafts" to="/drafts" icon={<TempIcon />} />
            <SidebarNavLink
              text="Bookmarks"
              to="/bookmarks"
              icon={<BookmarkIcon />}
            ...
            <div className="px-4">
              ...
              <h5>
                ...
                <TrendingIcon className="icon ml-2 opacity-50" />
              </h5>
              <TrendingTags />
            </div>
          </div>
