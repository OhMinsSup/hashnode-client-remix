    ...
    <div className={styles.root}>
      <div className={styles.container}>
        <div className={styles.desc_container}>
          <div className={styles.title_container}>
            <h1>
              <a itemProp="url" href="/@veloss990">
                <span itemProp="name">OhMinSup</span>
              </a>
            </h1>
          </div>
          <p itemProp="description">dsd</p>
        </div>
        <div className={styles.action_container}>
          <a href="/settings" className={styles.btn_setting}>
      ...
      <div className={styles.follow_container}>
        <a href="/@veloss990/following">
          <span className="font-bold">31</span> Following
        </a>
      </div>
    </div>
  );
