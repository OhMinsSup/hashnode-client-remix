...
const [Provider, useLayoutSizeMeasuringMachineContext] =
  createContext<SearchDialogContext>({
    name: 'useLayoutSizeMeasuringMachineContext',
    errorMessage:
      'useLayoutSizeMeasuringMachineContext: `context` is undefined.',
...
export { SearchDialogProvider, useLayoutSizeMeasuringMachineContext };
